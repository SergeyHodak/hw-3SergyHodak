/*
    Задание - округлить скорость
    Напиши метод public int roundSpeed(int speed). Он принимает на вход скорость
(всегда двузначное число, от 10 до 89 включительно). И возвращает это же число,
округленное по правилам математического округления.
*/

import java.util.*;

public class Tasck19 {
