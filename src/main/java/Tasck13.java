/*
    ...
    Напиши метод public String[] makeCopy(String[] names). Он принимает массив имен,
выводит в консоль текст "Copied!", и возвращает копию исходного массива.
Используй метод Arrays.copyOf() для копирования массива.
 */

import java.util.*;

public class Tasck13 {
    ...
    public static void main(String[] args) {
        ...
        String[] copy = new Tasck13().makeCopy(source);
